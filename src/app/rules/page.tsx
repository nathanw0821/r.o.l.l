  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6 py-6 px-4 animate-in fade-in duration-200">
      ...
      <div className="rounded-xl border border-border bg-panel p-6 space-y-5 font-mono text-xs leading-relaxed text-foreground/80">
        ...
        <section className="space-y-2">
          <h2 className="text-sm font-bold text-accent border-b border-border/60 pb-1 uppercase">2. Trading Etiquette ⚖️</h2>
        ...
        <section className="space-y-2">
          <h2 className="text-sm font-bold text-accent border-b border-border/60 pb-1 uppercase">3. No Bot Abuse or Exploits 🛠️</h2>
