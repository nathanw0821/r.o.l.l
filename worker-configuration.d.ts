/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: af338c3b5bf1fb655416f8a2669ceed2)
// Runtime types generated with workerd@1.20260801.1 2024-09-23 enable_nodejs_http_modules,nodejs_compat
interface __BaseEnv_Env {
	KV_LIMITER: KVNamespace;
	ASSETS: Fetcher;
	...
	XLS_CONVERTER_URL: string;
	XLS_CONVERTER_TOKEN: string;
	AD_PROVIDER: string;
	REWARDED_AD_ENABLED: string;
	REWARD_POINTS_MIN: string;
	REWARD_POINTS_MAX: string;
	AD_COOLDOWN_MINUTES: string;
	DAILY_POINTS_CAP: string;
	REWARDED_AD_MIN_SECONDS: string;
	GOOGLE_REWARDED_AD_UNIT: string;
	REWARDED_VIDEO_URL: string;
	SUPPORT_URL: string;
